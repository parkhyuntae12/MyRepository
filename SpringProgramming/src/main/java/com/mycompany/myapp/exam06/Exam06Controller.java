...
public class Exam06Controller {
	...
	public void method2(HttpServletRequest request, HttpServletResponse response) throws IOException{//response는 자동 flush생성(일회성)
		/*response.setContentType("application/json; charset=UTF-8");
		PrintWriter pw = response.getWriter();
		pw.println("{mid:'fall', mname:'한가을'}");//json의 형태
		pw.flush();
		pw.close();*/
	...
	public String method3(@RequestHeader("User-Agent") String userAgent){ // ()<- User-Agent:xxxxxxxxxxxxxxxxxxxxxxxx
